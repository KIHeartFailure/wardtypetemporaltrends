...
funcTab1 <- function(data, tabname) {
  ...
  tab2000 <- print(
    CreateTableOne(
      vars = tabvars,
      data = data %>% filter(indexYear_cat == "2000-2004"),
      strata = c("clinic")
    ),
    missing = FALSE,
    printToggle = FALSE,
  ...
  tab2005 <- print(
    CreateTableOne(
      vars = tabvars,
      data = data %>% filter(indexYear_cat == "2005-2008"),
      strata = c("clinic")
    ),
    missing = FALSE,
    printToggle = FALSE,
  ...
  tab2009 <- print(
    CreateTableOne(
      vars = tabvars,
      data = data %>% filter(indexYear_cat == "2009-2012"),
      strata = c("clinic")
    ),
    missing = FALSE,
    printToggle = FALSE,
  ...
  tab2013 <- print(
    CreateTableOne(
      vars = tabvars,
      data = data %>% filter(indexYear_cat == "2013-2016"),
      strata = c("clinic")
    ),
    missing = FALSE,
    printToggle = FALSE,
